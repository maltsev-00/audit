...
import com.innowise.audit.model.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<ErrorDetails>> handleNotFoundResourceStatusException(JsonParserException exception) {
        String message = exception.getMessage();
        log.error(message);
